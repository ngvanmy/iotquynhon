    ...
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        "prototype$__findById__accessTokens": {
          ...
          url: urlBase + "/appuser/:id/accessTokens/:fk",
          method: "GET"
        },
        ...
        "prototype$__get__accessTokens": {
          isArray: true,
          url: urlBase + "/appuser/:id/accessTokens",
          method: "GET"
        },
         ...
         */
        "prototype$__count__accessTokens": {
          url: urlBase + "/appuser/:id/accessTokens/count",
          method: "GET"
        },
         ...
         */
        "createChangeStream": {
          url: urlBase + "/appuser/change-stream",
          method: "POST"
        },
         ...
         */
        "resetPassword": {
          url: urlBase + "/appuser/reset",
          method: "POST"
        },

        // INTERNAL. Use Device.user() instead.
        "::get::device::user": {
          url: urlBase + "/device/:id/user",
          method: "GET"
        },
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
         ...
         */
        "createChangeStream": {
          url: urlBase + "/device/change-stream",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Device#getByUsers
         * @methodOf lbServices.Device
         *
         * @description
         *
         ...
         */
        "getByUsers": {
          url: urlBase + "/device/list-devices",
          method: "GET"
        },
      }
    );
